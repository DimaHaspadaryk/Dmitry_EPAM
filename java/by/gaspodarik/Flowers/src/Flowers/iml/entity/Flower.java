...
public class Flower {
    ...
    public Flower(int cost, double lenght, double weight, int fresh) {
        this.cost = cost;
        this.lenght = lenght;
        this.fresh = fresh;
        this.weight = weight;
    ...
    public boolean equals(Object o) {
        ...
        return Integer.compare(flower.cost, cost) == 0 && Double.compare(flower.lenght, lenght) == 0 && Double.compare(flower.weight, weight) == 0 && fresh == flower.fresh;
    }
